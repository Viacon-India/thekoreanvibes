...
<div class="trends-grid-card-wrapper col-end-[span_6] sm:col-end-[span_3] md:col-end-[span_3] lg:col-end-[span_3]" data-card_index="<?php echo $args['card_index']; ?>">
        ...
        <a href="<?php echo get_the_permalink($post_ID); ?>" aria-label="<?php echo the_title_attribute('echo=0'); ?>">
            <figure class="small-card-upper-text-figure">
                <?php if (has_post_thumbnail()) : ?>
                    <?php echo get_the_post_thumbnail($post_ID, 'default-small-thumbnail', array('class' => 'img-responsive')); ?>
                <?php else : ?>
