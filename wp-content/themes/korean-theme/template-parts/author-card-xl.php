...
<div class="trends-grid-card-wrapper col-end-[span_12] sm:col-end-[span_8] md:col-end-[span_8] lg:col-end-[span_8]" data-card_index="<?php echo $args['card_index']; ?>">
        ...
        <a href="<?php echo get_the_permalink($post_ID); ?>" aria-label="<?php echo the_title_attribute('echo=0'); ?>">
            <figure class="small-bottom-text-card-figure">
                <?php if (has_post_thumbnail()) : ?>
                    <?php echo get_the_post_thumbnail($post_ID, 'default-extra-large-thumbnail', array('class' => 'img-responsive')); ?>
                <?php else : ?>
