...
<div class="category-page-mentioner-columns-pin" data-card_index="<?php echo $args['card_index']; ?>">
    <div class="category-common-card">
        <a href="<?php echo get_the_permalink($post_ID); ?>">
            <figure class="category-c-large-figure">
                <?php if ( has_post_thumbnail()) : ?>
                    <?php echo get_the_post_thumbnail( $post_ID, 'listing-large-thumbnail', array( 'class' => 'img-responsive' ) ); ?>
                <?php else : ?>
                    <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/cat-l.jpg" alt="card image">
                <?php endif; ?>
            </figure>
        </a>
